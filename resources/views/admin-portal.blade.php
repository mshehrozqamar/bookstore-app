      ...
      <div class="modal-body">
        ...
        <div class="container mt-3">
            <div class="row rows-cols-3">
                ...
                <div class="col mt-2">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong" data-backdrop="static" data-keyboard="false">Add Book</button>
                </div>
                <div class="col mt-2">
               ...
               @foreach($books as $book)
                <div class="col mt-3">
                    <div class="card" style="width: 470px;">
                        ...
                        />
                        <div class="card-body">
                            <h4 class="card-title" style=" text-overflow: ellipsis; overflow: hidden; white-space: nowrap;">{{$book->name}}</h4>
                            <h6 class="card-subtitle">Author: {{$book->author}}</h6>
                            <p class="card-text">
                                Published By: {{$book->publisher}} <br />Publish Date: {{$book->published}}<br>Quantity: {{$book->quantity}}
                            </p>
                            <h4 class="card-title">${{$book->price}}</h4>
                            <div class="text-center">
                                <a href="populate/{{$book->id}}" class="btn btn-warning"
                                    >Update</a
                                >
                                <a href="delete-book/{{$book->id}}" class="btn btn-danger"
                                    >Delete</a
                                >
                            </div>
                        </div>
